...
create table campaign_data (campaign_id bigint generated by default as identity, created_at timestamp, details varchar(255), goal integer, image varchar(255), name varchar(255), reason varchar(255), campaign_status varchar(255), updated_at timestamp, video varchar(255), user_id bigint, primary key (campaign_id))
...
create table token_black_list (jti varchar(255) not null, expires bigint, is_black_listed boolean, user_id varchar(255), primary key (jti))
create table user_roles (user_id bigint not null, roles varchar(255))
alter table app_user add constraint UK_3k4cplvh82srueuttfkwnylq0 unique (username)
